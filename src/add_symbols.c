/*
 * THIS IS A HORRIBLE UGLY KLUDGE WHICH RELIES ON AN UNDOCUMENTED LINKER
 * FEATURE, TO FIX A PROBLEM BUILDING ONE PROGRAM ON ONE MISMATCHED COMBINATION
 * OF BUILD OS AND TARGET OS.  IT IS BY NO MEANS A COMPLETE SOLUTION TO THIS
 * PROBLEM IN GENERAL, AND ISN'T EVEN THE BEST SOLUTION IN THE CASE THAT
 * MOTIVATED IT.  IT ALSO CAUSES A TON OF WARNINGS FROM THE 10.6 LINKER.
 *
 * ONCE THE PROPER FIX IS IMPLEMENTED AND USED, THIS FILE WILL GO AWAY.
 * DON'T ADD ANY MORE SYMBOLS TO IT.
 */
